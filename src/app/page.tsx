...
// イラストをテーマに応じて出し分ける。*-dark.png は
// scripts/make-dark-illustrations.py で生成した暗所用(線が明るい)バリアント
function Illust({
  src,
  alt,
  width,
  ...
  return (
    <>
      <Image className="dark:hidden" src={src} alt={alt} width={width} height={height} priority={priority} />
      <Image
    ...
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-28 py-8 sm:gap-36">
      ...
      <section className="text-center">
        <div className="mx-auto mb-6 flex w-fit items-end justify-center">
          <Illust src="/illustrations/535.png" alt="" width={170} height={170} priority />
          <Illust src="/illustrations/536.png" alt="" width={170} height={170} priority />
        </div>
      ...
      <section id="why" className="reveal scroll-mt-20">
        <div className="mx-auto mb-4 w-fit">
          <Illust src="/illustrations/1122.png" alt="スマホのクソリプに手をかざす人のイラスト" width={150} height={150} />
        </div>
      ...
      <section id="features" className="reveal scroll-mt-20">
        <div className="mx-auto mb-4 w-fit">
          <Illust src="/illustrations/1628.png" alt="散布図を分析するイラスト" width={150} height={150} />
        </div>
          ...
          {STEPS.map((s, i) => (
            ...
            >
              ...
              <div className="hidden h-20 w-20 shrink-0 items-center justify-center self-center sm:flex">
                <Illust src={s.image} alt="" width={72} height={72} />
              </div>
            </li>
          ))}
        </ol>
      ...
      {featured.length > 0 && (
        <section id="themes" className="reveal scroll-mt-20">
          <div className="mx-auto mb-2 w-fit">
            <Illust src="/illustrations/1822.png" alt="" width={90} height={90} />
          </div>
      ...
      <section id="policy" className="reveal scroll-mt-20 rounded-lg border border-stone-200 bg-white p-6 text-center dark:border-stone-800 dark:bg-stone-900">
        <div className="mx-auto mb-3 w-fit">
          <Illust src="/illustrations/1498.png" alt="握手のイラスト" width={130} height={130} />
        </div>
