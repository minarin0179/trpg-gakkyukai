...
export default async function ThemesPage({ searchParams }: PageProps<"/themes">) {
  ...
  return (
    <div>
      <div className="mb-4 flex gap-1 border-b border-stone-400 dark:border-stone-800">
        <Link
          href="/themes"
      ...
      {list.length === 0 ? (
        <div className="rounded-lg border border-dashed border-stone-500 p-8 text-center text-sm text-stone-600 dark:border-stone-700 dark:text-stone-500">
          {showFresh ? (
            <>
              まだ新着テーマがありません。
