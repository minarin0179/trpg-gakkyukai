...
// 週間ダイジェストで意見を紹介するのに必要な最低投票数。
// 賛成率だけで選ぶと、3票中3票賛成のような「まだ何も分かっていない」意見が
// 合意として載ってしまう。意見マップに載る閾値(MAP_MIN_VOTES=7)より高くして、
// 週のまとめとして紹介するに足る量が集まった意見だけに絞る
export const DIGEST_MIN_VOTES = 30;
