...
export function ReportButton({
  ...
  if (state.done) {
    return <p className="mt-2 text-xs text-stone-500">通報を受け付けました。基準に照らして対応します。</p>;
  }

  return (
    <form action={formAction} className="mt-2 flex flex-col gap-2 rounded-md border border-stone-200 bg-stone-50 p-3">
